...
const SHOPPING_LINKS = [
  { emoji: '🌴', label: 'Medine Hurmaları', href: '#' },
  { emoji: '🍫', label: 'Çikolatalı Hurmalar', href: '#' },
  { emoji: '☕', label: 'Kahveler', href: '#' },
  { emoji: '🌰', label: 'Kuruyemiş', href: '#' },
  { emoji: '🍯', label: 'Yöresel Ürünler', href: '#' },
  { emoji: '✨', label: 'Fırsat Ürünleri', href: '#', highlight: true },
];

const SUPPORT_LINKS = [
  { icon: 'local_shipping', label: 'Sipariş Takip', href: '#' },
  { icon: 'support_agent', label: 'WhatsApp Destek', href: '#' },
];

const KURUMSAL_LINKS = [
  { icon: 'storefront', label: 'Toptan Satış', href: '#' },
];
      ...
      <main style={{
        ...
        <header style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 32 }}>
          ...
          <div style={{ display: 'flex', gap: 16 }}>
            {[
              { href: 'https://instagram.com/cancevizhurma', label: 'Instagram', icon: (
              ...
              { href: 'https://wa.me/905XXXXXXXXX', label: 'WhatsApp', icon: (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              { href: 'https://youtube.com/@cancevizhurma', label: 'YouTube', icon: (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <footer style={{
          ...
          <a href="https://cancevizhurma.com" style={{
            fontFamily: 'var(--font-jost), sans-serif',
            fontSize: 10, fontWeight: 600, letterSpacing: '0.1em',
